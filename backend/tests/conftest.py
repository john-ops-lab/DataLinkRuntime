...
def _truncate(engine: Engine) -> None:
    with engine.begin() as conn:
        conn.execute(
            text(
                "TRUNCATE TABLE user_templates, builtin_packages, builtin_package_uploads, "
                "builtin_package_settings, adapters, adapter_versions, adapter_schedules, "
                ...
                "worker_cache_management_children, worker_cache_snapshot_items, "
                "worker_cache_snapshots, "
                "worker_cache_management_operations, workers, worker_cache_operations, "
                "worker_cache_guards, executions, "
